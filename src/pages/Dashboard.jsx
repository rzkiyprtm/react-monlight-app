...
import jan from '../assets/images/Icon/jan.png'
import feb from '../assets/images/Icon/feb.png'
import mar from '../assets/images/Icon/mar.png'
import apr from '../assets/images/Icon/apr.png'
import may from '../assets/images/Icon/may.png'
import jun from '../assets/images/Icon/jun.png'
import jan1 from '../assets/images/Icon/jan1.png'
import feb1 from '../assets/images/Icon/feb1.png'
import mar1 from '../assets/images/Icon/mar1.png'
import apr1 from '../assets/images/Icon/apr1.png'
import may1 from '../assets/images/Icon/may1.png'
import jun1 from '../assets/images/Icon/jun1.png'
...
<NavbarAdmin/>
  ...
  <div className={css.checkboxgroup}>
    <input className={css.inputprofile} type="radio" name="radio" id="my_radio_button_id1" />
    <label for="my_radio_button_id1">Daily</label>
  </div>
  <div className={css.checkboxgroup}>
    <input className={css.inputprofile} type="radio" name="radio" id="my_radio_button_id2" />
    <label for="my_radio_button_id2">Weekly</label>
  </div>
  <div className={css.checkboxgroup}>
    <input className={css.inputprofile} type="radio" name="radio" id="my_radio_button_id3" />
      ...
      <div className={css.RightContainer}>
        <div className={css.StaffContainer}>
          <div className={css.Profile}>
            ...
            <h5>Putra Parker</h5>
            <p className={css.Quote}>Keep up the good work and spread love!</p>
            </div>
          </div>
            ...
            <div className={css.Staff}>
              ...
              <p className={css.AchieveTxt}>Achieved 3.5M of total 5M 478 Customer</p>
            </div>
        </div>
